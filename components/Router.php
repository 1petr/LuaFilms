       ...
       $uri = $this->getURI();
        ...
        foreach ($this->routes as $uriPattern => $path)
		{
            ...
            if (preg_match("~$uriPattern~", $uri))
            {
                ...
                //Вырезаем второй элемент из массива, добавляем к нему action и присваиваем, делая первую букву заглавной
				...
				//Проверка существования класса-котроллера
				if(($controllerName == ('FilmController'))||($controllerName == ('MoviesController'))||($controllerName == ('ReviewController')))
				{	
