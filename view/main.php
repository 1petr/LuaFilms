    ...
    <div class="row">
        <div id="carousel" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="item active"> <img src="/images/slides/1.jpg" alt="Сериал Ходячие мертвецы смотреть онлайн" title="Ходячие мертвецы">
...
<div class="container">
    ...
    <div class="row container_matrix">
        <?php foreach($filmList as $filmItem):?>
            <div itemscope itemtype="http://schema.org/Movie" class="col-xs-6 col-sm-4 col-md-3 col-lg-2 container_film" >
               <meta itemprop="inLanguage" content="ru">
               <meta itemprop="isFamilyFriendly" content="True">
                <div class="thumbnail"> <a href="/review/<?=$filmItem['id']?>"><img itemprop="image" src="<?=$filmItem['image']?>" alt="Стотреть онлайн <?=$filmItem['name']?>" title="<?=$filmItem['name']?>" ></a>
                    <!-- Set Firefox as main brouser -->
                    <div class="caption"> <a id="film-name" href="/review/<?=$filmItem['id']?>"><strong itemprop="name"><?=$filmItem['name']?></strong></a>
                        <br> <span>
                        ...
                        <h6><a itemprop="genre" id="caption-genre" href="/movies/genre/<? echo TranslateGenreOnEng($filmItem['genre']); ?>"><? echo $filmItem['genre']?></a>, <a id="caption-genre" href="/movies/country/<? echo TranslateCountryOnEng($filmItem['country']); ?>"><?=$filmItem['country']?></a>, <a id="caption-genre" href="/movies/year/<?=$filmItem['year']?>"><?=$filmItem['year']?></a></h6> </div>
                </div>
            </div>
            <?php endforeach; ?>
    </div>
