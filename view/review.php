...
<!--Слайдер------------------------------------------------------------------------------------------------------------------------------------>
<!--Контент------------------------------------------------------------------------------------------------------------------------------------>
<div itemscope itemtype="http://schema.org/Movie" class="container description">
   <meta itemprop="inLanguage" content="ru">
   <meta itemprop="isFamilyFriendly" content="True">
    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
        <div class="thumbnail"> <a href="<?=$filmItem['id']?>"><img itemprop="image" src="<?=$filmItem['image']?>" alt="Смотреть онлайн <?echo $filmItem['name']?>" title="<?echo $filmItem['name']?>"></a>
