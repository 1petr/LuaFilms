...
<div itemscope itemtype="http://schema.org/VideoObject" class="container description">
   ...
   <meta itemprop="video" content="http://luafilm.ru<? echo $filmItem['video']?>" />
    ...
    <div class="row">
      <?php $filmList = Film::getSeral($filmItem['name']); foreach($filmList as $filmItem):?>
         <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
           <div class="btn-group-vertical">
  				<a class="series-word" href="/review/serials/<?=$filmItem['series']?>"><button type="button" class="btn btn-primary btn-series">Серия <?=$filmItem['series']?></button></a>
		   </div>
	     </div>
  	  <?php endforeach; ?>
    </div>
