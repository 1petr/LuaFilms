               ...
               <meta itemprop="isFamilyFriendly" content="True">
                <div class="thumbnail"> <a href="/review/<?=$filmItem['id']?>"><img itemprop="image" src="<?=$filmItem['image']?>" alt="Стотреть онлайн <?=$filmItem['name']?>" title="<?=$filmItem['name']?>" ></a>
                    ...
                    <div class="caption"> <a id="film-name" href="/review/<?=$filmItem['id']?>"><strong itemprop="name"><?=$filmItem['name']?></strong></a>
                        ...
                        <h6><a itemprop="genre" id="caption-genre" href="/movies/genre/<? echo TranslateGenreOnEng($filmItem['genre']); ?>"><? echo $filmItem['genre']?></a>, <a id="caption-genre" href="/movies/country/<? echo TranslateCountryOnEng($filmItem['country']); ?>"><?=$filmItem['country']?></a>, <a id="caption-genre" href="/movies/year/<?=$filmItem['year']?>"><?=$filmItem['year']?></a></h6>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
